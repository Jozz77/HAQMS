...
router.post('/checkin', authenticate, async (req, res) => {
  try {
    ...
    // Serialize token-number assignment per doctor per day using a DB transaction + row lock.
    // This prevents concurrent check-ins from issuing duplicate token numbers.
